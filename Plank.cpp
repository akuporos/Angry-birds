...
Plank::Plank(sf::Texture& plank1, int x, int y, int angle, b2World& world_) : world(world_), Damagable(1000)
{
	...
	plank->SetAsBox(50.0f / common::met_to_pix, 5.0f / common::met_to_pix);
